...
f0 = function(S, E11a, E5, coeff=-27) {
	- 50*S^3*E5 - 10*E11a^4 - 2*S^3*E11a^5/E5 + 9*S*E11a^6/E5 - 10*E11a^3*S^2 +
	+ 12*E11a^2*S^4 + coeff[1]*E11a*E5*S;
}
f1 = function(S, E11a, E5, coeff=c(-127, -25)) {
	- 2*S^3*E11a^5/E5 - 10*E11a^3*S^2 + coeff[1]*E11a*E5*S + coeff[2]*E11a*S^6;
}
...
27*(E11a^7 + E11b^7)*E5^2 +
	...
	+ ...*(E11a*E11b)*(E11a^2 + E11b^2)*E5^3*S + ...*(E11a*E11b)*(E11a^2 + E11b^2)*E5^2*S^6 +
