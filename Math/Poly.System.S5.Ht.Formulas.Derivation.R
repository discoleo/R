...
max.pow.S(c("E4V1001", "E4Vn1001", "E4V1001", "E4Vn1001"), pow=0, FUN=f0, R=c(1,0,0,1,2), R2=c(1.3,0,0,1,2), skip.path=T)
max.pow.S(c("E4V1001", "E4V100n1", "E4V1001", "E4V100n1"), pow=0, FUN=f0, npos=4, R=c(1,0,0,1,2), R2=c(1,0,0,1.3,2), skip.path=T)
...
cc = list(c(1,0,0,1,2), c(1.3,0,0,1,2), c(0.9,0,0,1.2,2.1), c(1.2,0,0,4/5,1.9))
tmp = sapply(cc, function(R) polyS(R, "E4V1001"));
c0 = c(...) / 2;
m = sapply(cc, fc)
...
27*(E11a^7 + E11b^7)*E5^2 +
	...
	# x^5:
	+ (E11a^5 + E11b^5)*(9*E5^2*S^4 - E4^3*S^2 - 90*E3*E5^2*S - 3*E4^2*E5*S +
	...
	+ (E11a^4 + E11b^4)*(48*E3*E5^2*S^3 - E5^2*S^6 - 31*E4^2*E5*S^3 +
		- 10*E3^3*E5*S^2 + 345*E4*E5^2*S^2 +
	...
	# x^3:
	- (E11a^3 + E11b^3)*(6*E3*E5^2*S^5 - 16*E4^2*E5*S^5 - 2*E3^3*E5*S^4 + 122*E4*E5^2*S^4 +
		+ 50*E5^3*S^3 - 5*E3^2*E5^2*S^2 - 29*E4^4*S^2 - 15*E4^3*E5*S - 6*E3^4*E5*S +
	...
	# x^2:
	+ (E11a^2 + E11b^2)*(- 2*E4^2*E5*S^7 + 12*E4*E5^2*S^6 + 14*E5^3*S^5 +
		- 21*E3^2*E5^2*S^4 - 17*E4^4*S^4 + 8*E3^4*E5*S^3 + 59*E4^3*E5*S^3 +
		- E3^6*S^2 + 500*E3*E5^3*S^2 - 500*E4^2*E5^2*S^2 - 200*E3^3*E5^2*S + 625*E4*E5^3*S +
	...
	# x^1:
	+ (E11a + E11b)*(7*E4^4*S^6 - 62*E4^3*E5*S^5 - 150*E3*E5^3*S^4 + 420*E4^2*E5^2*S^4 +
		+ 110*E3^3*E5^2*S^3 - 1250*E4*E5^3*S^3 +
		+ 5^5*E5^4*S^2 - 26*E3^5*E5*S^2 - 35*E4^5*S^2 +
		+ 2*E3^7*S - 1250*E3^2*E5^3*S + 100*E4^4*E5*S + 125*E3^4*E5^2 - 625*E4^3*E5^2 +
	...
	# B0:
	- E4^4*S^8 + 12*E4^3*E5*S^7 - 86*E4^2*E5^2*S^6 + 300*E4*E5^3*S^5 +
		+ 10*E4^5*S^4 - 5^4*E5^4*S^4 + 500*E3^2*E5^3*S^3 - 60*E4^4*E5*S^3 +
		- 150*E3^4*E5^2*S^2 + 250*E4^3*E5^2*S^2 + 20*E3^6*E5*S +
...
f0 = function(R) {
	...
	cc = 27*E5^2*E11a^7 +
		...
		+ E11a^5*(9*E5^2*S^4 - E4^3*S^2 - 90*E3*E5^2*S - 3*E4^2*E5*S +
			+ 4*E3^3*E5 - 225*E4*E5^2 - E3^2*E4^2) +
		- E11a^4*(E5^2*S^6 - 48*E3*E5^2*S^3 + 31*E4^2*E5*S^3 +
			+ 10*E3^3*E5*S^2 - 345*E4*E5^2*S^2 +
			- 150*E3^2*E5^2 + 33*E4^4 - 155*E3*E4^2*E5) +
		- E11a^3*(6*E3*E5^2*S^5 - 16*E4^2*E5*S^5 - 2*E3^3*E5*S^4 + 122*E4*E5^2*S^4 + 50*E5^3*S^3 +
			- 5*E3^2*E5^2*S^2 - 29*E4^4*S^2 - 6*E3^4*E5*S - 15*E4^3*E5*S +
			- 375*E4^2*E5^2 - 29*E3^2*E4^3 + 105*E3^3*E4*E5) +
		+ E11a^2*( - 2*E4^2*E5*S^7 + 12*E4*E5^2*S^6 + 14*E5^3*S^5 - 21*E3^2*E5^2*S^4 - 17*E4^4*S^4 +
			+ 8*E3^4*E5*S^3 + 59*E4^3*E5*S^3 + 500*E3*E5^3*S^2 - 500*E4^2*E5^2*S^2 - E3^6*S^2 +
			- 200*E3^3*E5^2*S + 625*E4*E5^3*S +
			- 3125*E5^4 + 12*E3^5*E5 + 54*E4^5 - 275*E3*E4^3*E5 - 250*E3^2*E4*E5^2 - 17*E3^4*E4^2) +
		- E11a*( - 7*E4^4*S^6 + 62*E4^3*E5*S^5 + 150*E3*E5^3*S^4 - 420*E4^2*E5^2*S^4 +
			- 110*E3^3*E5^2*S^3 + 1250*E4*E5^3*S^3 - 3125*E5^4*S^2 + 26*E3^5*E5*S^2 + 35*E4^5*S^2 +
			- 2*E3^7*S + 1250*E3^2*E5^3*S - 100*E4^4*E5*S +
			- 125*E3^4*E5^2 + 625*E4^3*E5^2 - 3125*E3*E4*E5^3 + 35*E3^2*E4^4 - 175*E3^3*E4^2*E5 - 7*E3^6*E4) +
		- E4^4*S^8 + 12*E4^3*E5*S^7 - 86*E4^2*E5^2*S^6 + 300*E4*E5^3*S^5 +
			+ 10*E4^5*S^4 - 625*E5^4*S^4 + 500*E3^2*E5^3*S^3 - 60*E4^4*E5*S^3 +
			- 150*E3^4*E5^2*S^2 + 250*E4^3*E5^2*S^2 + 20*E3^6*E5*S +
...
f1 = function(R) {
	S = R[1]; E11a = R[2]; E3 = R[3]; E4 = R[4]; E5 = R[5];
	cc = 7*E4^4*S^6 - 62*E4^3*E5*S^5 - 150*E3*E5^3*S^4 + 420*E4^2*E5^2*S^4 +
			+ 110*E3^3*E5^2*S^3 - 1250*E4*E5^3*S^3 +
			+ 3125*E5^4*S^2 - 26*E3^5*E5*S^2 - 35*E4^5*S^2 +
			+ 2*E3^7*S - 1250*E3^2*E5^3*S + 100*E4^4*E5*S +
...
f2 = function(R) {
	S = R[1]; E11a = R[2]; E3 = R[3]; E4 = R[4]; E5 = R[5];
	cc = - 2*E4^2*E5*S^7 + 12*E4*E5^2*S^6 + 14*E5^3*S^5 - 21*E3^2*E5^2*S^4 - 17*E4^4*S^4 +
			+ 8*E3^4*E5*S^3 + 59*E4^3*E5*S^3 +
			- E3^6*S^2 + 500*E3*E5^3*S^2 - 500*E4^2*E5^2*S^2 +
			- 200*E3^3*E5^2*S + 625*E4*E5^3*S +
...
f3 = function(R) {
	S = R[1]; E11a = R[2]; E3 = R[3]; E4 = R[4]; E5 = R[5];
	cc = 16*E4^2*E5*S^5 - 6*E5^2*E3*S^5 + 2*E5*E3^3*S^4 - 122*E4*E5^2*S^4 - 50*E5^3*S^3 +
			+ 5*E5^2*E3^2*S^2 + 29*E4^4*S^2 + 6*E5*E3^4*S + 15*E4^3*E5*S +
			+ 375*E4^2*E5^2 + 29*E3^2*E4^3 - 105*E3^3*E4*E5 +
...
f4 = function(R) {
	S = R[1]; E11a = R[2]; E3 = R[3]; E4 = R[4]; E5 = R[5];
	cc = - E5^2*S^6 + 48*E3*E5^2*S^3 - 31*E4^2*E5*S^3 - 10*E3^3*E5*S^2 + 345*E4*E5^2*S^2 +
		+ 150*E3^2*E5^2 - 33*E4^4 + 155*E3*E4^2*E5 +
...
f5 = function(R) {
	S = R[1]; E11a = R[2]; E3 = R[3]; E4 = R[4]; E5 = R[5];
	cc = 9*E5^2*S^4 - E4^3*S^2 - 3*E4^2*E5*S - 90*E3*E5^2*S +
