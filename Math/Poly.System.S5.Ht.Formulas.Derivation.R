...
max.pow.S(c("E4V1011", "E4Vn1011", "E4V2011", "E4Vn2011"), pow=1, FUN=f1, R=c(1,0,1,1,2), R2=c(3,0,1,1,2), skip.path=T)
max.pow.S(c("E4V1011", "E4V101n1", "E4V1011", "E4V101n1"), pow=1, FUN=f1, npos=4, R=c(1,0,1,1,2), R2=c(1,0,1,1.3,2), skip.path=T)
...
cc = list(c(1,0,1,1,2), c(2,0,1.1,1.3,2), c(1.3,0,0.9,1,2.1), c(2.1,0,0.9,1.1,2.3),
	c(2.2,0,1,0.8,1.9), c(3,0,1.2,0.9,2.2), c(3.3,0,4/5,1.2,2.2));
