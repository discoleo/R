...
27*(E11a^7 + E11b^7)*E5^2 +
	...
	+ (E11a^2 + E11b^2)*(14*E5^3*S^5 + 500*E3*E5^3*S^2 - 21*E3^2*E5^2*S^4 - E3^6*S^2 +
		- 200*E3^3*E5^2*S + 8*E3^4*E5*S^3 + 12*E3^5*E5 - 5^5*E5^4 + 54*E4^5) +
	+ (E11a*E11b)*(E11a + E11b)*(200*E5^3*S^3 + 5^4*E3*E5^3 - 2*E3^6 +
		+ 6*E3*E5^2*S^5 - 8*E3^3*E5*S^4 + 2*E3^5*S^3 - 20*E3^2*E5^2*S^2 + 30*E3^4*E5*S) +
	...
	# B0:
	- 5^4*E5^4*S^4 - E3^8 - 150*E3^4*E5^2*S^2 + 20*E3^6*E5*S + 500*E3^2*E5^3*S^3 - 25*E4^6 # = 0
...
f0 = function(R) {
	S = R[1]; E11a = R[2]; E3 = R[3]; E4 = R[4]; E5 = R[5];
	cc = 27*E5^2*E11a^7 +
		- E11a^6*(27*S^2*E5^2 - 4*E4^3) +
		+ E11a^5*(9*E5^2*S^4 + 4*E3^3*E5 - 90*E3*E5^2*S - 225*E4*E5^2) +
		- E11a^4*(E5^2*S^6 - 150*E3^2*E5^2 - 48*E3*E5^2*S^3 + 10*E3^3*E5*S^2 + 33*E4^4) +
...
f2 = function(R) {
	...
	cc = 14*E5^3*S^5 - 21*E3^2*E5^2*S^4 + 8*E3^4*E5*S^3 - E3^6*S^2 + 500*E3*E5^3*S^2 +
		- 200*E3^3*E5^2*S - 3125*E5^4 + 12*E3^5*E5 + 54*E4^5 +
...
f3 = function(R) {
	S = R[1]; E11a = R[2]; E3 = R[3]; E4 = R[4]; E5 = R[5];
	cc = - 50*E5^3*S^3 - 6*E5^2*E3*S^5 + 5*E5^2*E3^2*S^2 + 2*E5*E3^3*S^4 + 6*E5*E3^4*S +
		+ 375*E4^2*E5^2 +
