...
27*(E11a^7 + E11b^7)*E5^2 +
	# x^6
	- (E11a^6 + E11b^6)*(27*E5^2*S^2 - 4*E4^3) - (E11a*E11b)^6 +
	+ 81*E11a*E11b*(E11a^5 + E11b^5)*E5^2 + 9*(E11a*E11b)^3*(E11a^3 + E11b^3)*E5*S +
	# x^5:
	+ (E11a^5 + E11b^5)*(9*E5^2*S^4 + 4*E3^3*E5 - 90*E3*E5^2*S - 225*E4*E5^2) +
	...
	+ (E11a^4 + E11b^4)*(48*E3*E5^2*S^3 - E5^2*S^6 - 10*E3^3*E5*S^2 + 150*E3^2*E5^2 - 33*E4^4) +
	...
	+ (E11a^3 + E11b^3)*(6*E3^4*E5*S - 6*E3*E5^2*S^5 +
		+ 2*E3^3*E5*S^4 - 50*E5^3*S^3 + 5*E3^2*E5^2*S^2 + 375*E4^2*E5^2) +
...
f4 = function(R) {
	S = R[1]; E11a = R[2]; E3 = R[3]; E4 = R[4]; E5 = R[5];
	cc = 150*E3^2*E5^2 - 10*E3^3*E5*S^2 + 48*E3*E5^2*S^3 - E5^2*S^6 - 33*E4^4 +
...
f5 = function(R) {
	S = R[1]; E11a = R[2]; E3 = R[3]; E4 = R[4]; E5 = R[5];
	9*S^4 - 90*E3*S + 4*E3^3/E5 - 225*E4 +
	+ 9*E11a*E3^2*S/E5 +
...
f6 = function(R) {
	S = R[1]; E11a = R[2]; E3 = R[3]; E4 = R[4]; E5 = R[5];
	- 27*S^2 - E11a^6/E5^2 + 81*E11a + 9*E11a^3*S/E5 + 4*E4^3/E5^2;
}
