...
x0All = list(
	...
	# R2 = c(0,0,-1,0,2)
	E3V00n1 = rbind(
	c(-0.9752+0.5286i, 0.9996+0i, -0.9752-0.5286i, 0.4754+1.1832i, 0.4754-1.1832i),
	c(-0.5775-0.6617i, 0.7261+0i, -0.5775+0.6617i, 0.2144+1.8775i, 0.2144-1.8775i),
	c(0.4752+1.184i, 0.999+0i, 0.4752-1.184i, -0.9747-0.5291i, -0.9747+0.5291i),
	c(-0.0251+0.9654i, -0.6528-0.3952i, 0.7368-0.2174i, 1.0916-1.6847i, -1.1505+1.3319i),
	c(-0.0251-0.9654i, -0.6528+0.3952i, 0.7368+0.2174i, 1.0916+1.6847i, -1.1505-1.3319i),
	c(0.3174+0.7952i, -0.7624-0.1552i, -1.8434+0.5369i, 1.662-0.5374i, 0.6265-0.6395i),
	c(0.3174-0.7952i, -0.7624+0.1552i, -1.8434-0.5369i, 1.662+0.5374i, 0.6265+0.6395i)
	),
	# R2 = c(0,1,1,0,2)
	E3V011 = rbind(
	c(-0.7782+0.8728i, 1.1902+0i, -0.7782-0.8728i, 0.1831+1.0933i, 0.1831-1.0933i),
	c(-0.3436-0.6734i, 0.812+0i, -0.3436+0.6734i, -0.0624+2.0751i, -0.0624-2.0751i),
	c(0.2947+0.8065i, 1.674+0i, 0.2947-0.8065i, -1.1317-0.5828i, -1.1317+0.5828i),
	c(-0.0924+0.7426i, -0.5497-0.553i, 0.834-0.2807i, 0.8386-1.6937i, -1.0306+1.7848i),
	c(-0.0924-0.7426i, -0.5497+0.553i, 0.834+0.2807i, 0.8386+1.6937i, -1.0306-1.7848i),
	c(0.1651+0.7636i, -0.8588-0.4554i, -1.43+0.9054i, 1.6488-0.4345i, 0.475-0.7791i),
	c(0.1651-0.7636i, -0.8588+0.4554i, -1.43-0.9054i, 1.6488+0.4345i, 0.475+0.7791i)
	),
	# R2 = c(0,1,-1,0,2)
	E3V01n1 = rbind(
	c(-0.8953+0.5952i, 0.9205+0i, -0.8953-0.5952i, 0.435+1.3002i, 0.435-1.3002i),
	c(-0.4992-0.6325i, 0.6814+0i, -0.4992+0.6325i, 0.1584+2.1203i, 0.1584-2.1203i),
	c(0.5094+0.9501i, 1.2607+0i, 0.5094-0.9501i, -1.1398-0.257i, -1.1398+0.257i),
	c(-0.1514+0.9422i, -0.6136-0.426i, 0.7061-0.1739i, 1.0093-1.8802i, -0.9504+1.538i),
	c(-0.1514-0.9422i, -0.6136+0.426i, 0.7061+0.1739i, 1.0093+1.8802i, -0.9504-1.538i),
	c(0.3004+0.8644i, -0.7936-0.2177i, -1.631+0.6268i, 1.3553-0.591i, 0.7688-0.6824i),
	c(0.3004-0.8644i, -0.7936+0.2177i, -1.631-0.6268i, 1.3553+0.591i, 0.7688+0.6824i)
	)
);
