...
f32 = function(S, E11a, E5) {
	- 50*S^3*E5 - 10*E11a^4 + 9*S*E11a^6/E5 + 12*E11a^2*S^4;
} # OK
f31 = function(S, E11a, E5, coeff=c(-68, 4)) {
	 - 375*E11a*E5*S - 2*S^3*E11a^5/E5 + coeff[1]*E11a^3*S^2 + coeff[2]*E11a*S^6;
}
f31S = function(S, E11a, E5) {
	- 50*S^3*E5 - 2*S^3*E11a^5/E5 + 9*S*E11a^6/E5 - 375*E11a*E5*S;
} # OK
f32S = function(S, E11a, E5, coeff=c(-68, 4)) {
	- 10*E11a^4 + 12*E11a^2*S^4 + coeff[1]*E11a^3*S^2 + coeff[2]*E11a*S^6;
}
