...
max.pow.S(c("E4V1001", "E4Vn1001", "E4V1001", "E4Vn1001"), pow=3, FUN=f3, skip.path=T, R=c(1,0,0,1,2), R2=c(1.3,0,0,1,2))
max.pow.S(c("E3V111", "E3V1n11", "E3V131", "E3V1n31"), pow=1, FUN=f1, skip.path=F, npos=2, R=c(1.2,1,0.9,0,2), R2=c(0.9,3,1.2,0,2))


fc = function(R) { S = R[1]; E3 = R[3]; E4 = R[4]; E5 = R[5];
	c(...); }

cc = list(c(1,0,0,1,2), c(1.3,0,0,1,2))
tmp = sapply(cc, function(R) polyS(R, "E4V1001"));
c0 = c(...)
m = sapply(cc, fc)
solve(t(m), c0 - sapply(cc, f4))
...
27*(E11a^7 + E11b^7)*E5^2 +
	...
	+ (E11a^4 + E11b^4)*(48*E3*E5^2*S^3 - E5^2*S^6 - 10*E3^3*E5*S^2 +
		+ 150*E3^2*E5^2 - 33*E4^4 + 155*E3*E4^2*E5 - 31*E4^2*S^3*E5 + 345*E4*S^2*E5^2) +
	...
	# x^3:
	- (E11a^3 + E11b^3)*(6*E3*E5^2*S^5 - 2*E3^3*E5*S^4 + 50*E5^3*S^3 - 5*E3^2*E5^2*S^2 +
		- 6*E3^4*E5*S - 375*E4^2*E5^2 - 29*E3^2*E4^3 + 105*E3^3*E4*E5) +
	+ (E11a*E11b)*(E11a^2 + E11b^2)*(4*E5^2*S^6 - 27*E3^3*E5*S^2 + 275*E3^2*E5^2 - 375*E5^3*S +
		- 2*E3^2*E5*S^5 + 68*E3*E5^2*S^3 + 2*E3^5*S) +
	...
	# x^2:
	+ (E11a^2 + E11b^2)*(14*E5^3*S^5 - 21*E3^2*E5^2*S^4 + 8*E3^4*E5*S^3 +
		+ 500*E3*E5^3*S^2 - E3^6*S^2 - 200*E3^3*E5^2*S +
...
f2 = function(R) {
	S = R[1]; E11a = R[2]; E3 = R[3]; E4 = R[4]; E5 = R[5];
	cc = 14*E5^3*S^5 - 21*E3^2*E5^2*S^4 + 8*E3^4*E5*S^3 - E3^6*S^2 + 500*E3*E5^3*S^2 +
			- 200*E3^3*E5^2*S +
...
f3 = function(R) {
	S = R[1]; E11a = R[2]; E3 = R[3]; E4 = R[4]; E5 = R[5];
	cc = - 6*E5^2*E3*S^5 + 2*E5*E3^3*S^4 - 50*E5^3*S^3 + 5*E5^2*E3^2*S^2 + 6*E5*E3^4*S +
			+ 375*E4^2*E5^2 + 29*E3^2*E4^3 - 105*E3^3*E4*E5 +
		+ E11a*(4*E5^2*S^6 - 2*E3^2*E5*S^5 + 68*E3*E5^2*S^3 - 375*E5^3*S + 2*E3^5*S +
			+ 275*E5^2*E3^2 - 27*E3^3*E5*S^2) +
		+ E11a^2*(12*E5^2*S^4 - 3*E5*E3^3 + 11*E3^2*E5*S^3 - 6*E3^4*S^2 + 140*E3*E5^2*S) +
		- E11a^3*(68*E5^2*S^2 + 4*E3^4 + 8*E3*E5*S^4 - 4*E3^3*S^3 + 26*E3^2*E5*S) +
		+ E11a^4*(6*E3^3*S - 10*E5^2) +
		- E11a^5*(2*E5*S^3 + 15*E5*E3) + 9*E11a^6*(E5*S);
	cc / E5^2;
}
f4 = function(R) {
	S = R[1]; E11a = R[2]; E3 = R[3]; E4 = R[4]; E5 = R[5];
	cc = - E5^2*S^6 + 48*E3*E5^2*S^3 - 31*E4^2*S^3*E5 - 10*E3^3*E5*S^2 + 345*E4*S^2*E5^2 +
		+ 150*E3^2*E5^2 - 33*E4^4 + 155*E3*E4^2*E5 +
