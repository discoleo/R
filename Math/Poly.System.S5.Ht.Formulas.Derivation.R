...
max.pow.S(c("E4V1001", "E4Vn1001", "E4V1001", "E4Vn1001"), pow=2, FUN=f2, R=c(1,0,0,1,2), R2=c(1.3,0,0,1,2), skip.path=T)
max.pow.S(c("E4V1001", "E4V100n1", "E4V1001", "E4V100n1"), pow=2, FUN=f2, npos=4, R=c(1,0,0,1,2), R2=c(1,0,0,1.3,2), skip.path=T)
...
f3 = function(R) {
	...
	cc = 16*E4^2*E5*S^5 - 6*E5^2*E3*S^5 + 2*E5*E3^3*S^4 - 122*E4*E5^2*S^4 - 50*E5^3*S^3 +
		...
		- E11a^3*(8*E3*E5*S^4 - 4*E3^3*S^3 + 68*E5^2*S^2 + 4*E3^4 + 26*E3^2*E5*S) +
