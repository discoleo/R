...
R2 = c(-1,1/3,0,0,2)
278.3705 + 1.998869*x - 12494.56*x^2 + 350.0226*x^3 - 6.388888*x^4 + 12.05556*x^5 - 0.1670072*x^6 + 27*x^7
...
f1 = function(S, E11a, E5, coeff=8, coeff2=-28) {
	cc = 3125*S^2*E5^4 - 28*S^5*E5^3*E11a - 9375*E5^4*E11a + 200*S^3*E5^3*E11a^2 + 4*S^6*E5^2*E11a^3 - 375*S*E5^3*E11a^3 - 21*S^4*E5^2*E11a^4 + 81*E5^2*E11a^6;
	cc / E5^2;
}
...
f3 = function(S, E11a, E5, coeff=c(-68, 4)) { # c(-14,-2)
	- 50*S^3*E5 - 10*E11a^4 - 2*S^3*E11a^5/E5 + 9*S*E11a^6/E5 +
	+ 12*E11a^2*S^4 - 375*E11a*E5*S + coeff[1]*E11a^3*S^2 + coeff[2]*E11a*S^6;
}
