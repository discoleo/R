...
integrate(\(y) (2/ (1-y^2)^4 - 5/(1-y^2)^3) * (log(y^2 + (1-y^2)^2) - log(y^2)) +
	- 1/2/(1-y)^2 + 1/(1-y), 0, 1)$value / 4 + pi * 7/12 + log(2) / 4 - 1/4 - 1/16 +
	+ (pi^2/4 + Im(acos(2+0i))^2) / 8;
# TODO

# Helper:
integrate(\(x) 1/(1-x^2) * (log(x^2 + (1-x^2)^2) - log(x^2)), 0, 1)
2 * atan((1+1i*sqrt(3))/2) * atan((1-1i*sqrt(3))/2);
(pi^2/4 + Im(acos(2+0i))^2) / 2;

#
integrate(\(x) 1/(1-x^2)^2 * (log(x^2 + (1-x^2)^2) - log(x^2)), 0, 1)
(pi^2/4 + 2*pi + Im(acos(2+0i))^2) / 4;
...
### I( x*y * atan(sqrt(y-x)) / (y-x) )
integrate(\(x) sapply(x, \(y) integrate(\(x)
	x*y * atan(sqrt(y-x)) / (y-x), 0, y, rel.tol=1E-11)$value), 0, 1, rel.tol=1E-13)
(Catalan - pi/4)*2/3 - (digamma(7/4) - digamma(9/4)) / 18 + 7/27;


### ATAN( SQRT(y^2-x^2) ) / (y-x)
...
### I( x*y * atan(sqrt(y^2-x^2)) / sqrt(y^2-x^2) )
integrate(\(x) sapply(x, \(y) integrate(\(x)
