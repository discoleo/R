...
# I( x^n * (1 + x^n)^(1-1/n) / (x^(3*n) + 1) )
# I( (1 - x^3)^(2/3) / (x^9 + 1) )
# I( (1 - x^5)^(4/5) / (x^15 + 1) )
# I( (1 - x^n)^(1-1/n) / (x^(3*n) + 1) )
# I( x^p * (1 - x^n)^(1 - (p+1)/n) / (x^(3*n) + 1) )
### Simple:
# I( 1 / (x^n + 1)^(1/n) )
# I( (1 - x^n)^(1 - 1/n) )
...
# Solution:
x = 2^(-1/3); x1 = x * (1+1i)^(1/3); x2 = x * (1-1i)^(1/3);
id = c(2); cs = cos(pi*id/3); sn = sin(pi*id/3);
- log(1 - x)/3 +
	- 1/3 * sum(cs*log(x^2 - 2*cs*x + 1) +
	- 2*sn * (atan((x - cs)/sn) + atan(cs/sn))) +
	+ 1/2 * Re(log(1 - x1) * (1+1i)^(2/3)/3 +
		+ (1+1i)^(2/3)/3 * sum(cs*log(x1^2 - 2*cs*x1 + 1) +
		- 2*sn * (atan((x1 - cs)/sn) + atan(cs/sn))) +
		+ log(1 - x2) * (1-1i)^(2/3)/3 +
		+ (1-1i)^(2/3)/3 * sum(cs*log(x2^2 - 2*cs*x2 + 1) +
...
### I( (1 - x^5)^(4/5) / (x^5 + 1) )
integrate(\(x) (1 - x^5)^(4/5) / (x^5 + 1), 0, 1)
(2^(4/5) - 1) * beta(1/5, 4/5) / 5
...
### I( x^3 * (1 - x^3)^(2/3) / (x^6 - x^3 + 1) )
integrate(\(x) x^3 * (1 - x^3)^(2/3) / (x^6 - x^3 + 1), 0, 1)
beta(1/3, 2/3) / 3 * (-1 + 2/sqrt(3)*sin(4*pi/9))
beta(1/3, 2/3) / 3 * (-1 + sin(4*pi/9)/sin(2*pi/3))

### I( x^6 * (1 - x^3)^(2/3) / (x^9 + 1) )
integrate(\(x) x^6 * (1 - x^3)^(2/3) / (x^9 + 1), 0, 1)
beta(1/3, 2/3) / 9 * (2^(2/3) - 3 + 3*sin(4*pi/9)/sin(2*pi/3) - 2*cos(pi/9));

### I( (1 - x^3)^(2/3) / (x^9 + 1) )
integrate(\(x) (1 - x^3)^(2/3) / (x^9 + 1), 0, 1)
beta(1/3, 2/3) / 9 * (2^(2/3) + 4*cos(pi/9) - 3*sin(4*pi/9)/sin(2*pi/3));


### Pow = 5

### I( x^5 * (1 - x^5)^(4/5) / (x^10 - x^5 + 1) )
integrate(\(x) x^5 * (1 - x^5)^(4/5) / (x^10 - x^5 + 1), 0, 1)
beta(1/5, 4/5) / 5 * (-1 + sin(6*pi/15)/sin(2*pi/3))

### I( x^10 * (1 - x^5)^(4/5) / (x^15 + 1) )
integrate(\(x) x^10 * (1 - x^5)^(4/5) / (x^15 + 1), 0, 1)
beta(1/5, 4/5) / 15 * (2^(4/5) - 3 + 3*sin(6*pi/15)/sin(2*pi/3) - 2*cos(pi/15))

### I( (1 - x^5)^(4/5) / (x^15 + 1) )
integrate(\(x) (1 - x^5)^(4/5) / (x^15 + 1), 0, 1)
beta(1/5, 4/5) / 15 * (2^(4/5) + 4*cos(pi/15) - 3*sin(6*pi/15)/sin(2*pi/3));


### Gen:

### I( x^n * (1 - x^n)^(1-1/n) / (x^(2*n) - x^n + 1) )
n = sqrt(5)
integrate(\(x) x^n * (1 - x^n)^(1-1/n) / (x^(2*n) - x^n + 1), 0, 1)
beta(1/n, 1 - 1/n) / n * (-1 + sin((n+1)*pi/(3*n))/sin(2*pi/3))

### I( x^(2*n) * (1 - x^n)^(1-1/n) / (x^(3*n) + 1) )
integrate(\(x) x^(2*n) * (1 - x^n)^(1-1/n) / (x^(3*n) + 1), 0, 1, rel.tol=1E-9)
beta(1/n, 1 - 1/n) / (3*n) * (2^(1-1/n) - 3 +
	+ 3*sin((n+1)*pi/(3*n))/sin(2*pi/3) - 2*cos(pi/(3*n)))

### I( (1 - x^n)^(1-1/n) / (x^(3*n) + 1) )
integrate(\(x) (1 - x^n)^(1-1/n) / (x^(3*n) + 1), 0, 1)
beta(1/n, 1 - 1/n) / (3*n) * (2^(1-1/n) +
	+ 4*cos(pi/(3*n)) - 3*sin((n+1)*pi/(3*n))/sin(2*pi/3));


### Gen: Variant: x * Radical
n = sqrt(7)
integrate(\(x) x * (1 - x^n)^(1-2/n) / (x^(3*n) + 1), 0, 1)
beta(2/n, 1 - 2/n) / (3*n) * (2^(1-2/n) +
	+ 4*cos(2*pi/(3*n)) - 3*sin((n+2)*pi/(3*n))/sin(2*pi/3));


### I( x^p * (1 - x^n)^(1 - (p+1)/n) / (x^(3*n) + 1) )
n = sqrt(11); p = sqrt(3);
integrate(\(x) x^p * (1 - x^n)^(1 - (p+1)/n) / (x^(3*n) + 1), 0, 1)
beta((p+1)/n, 1 - (p+1)/n) / (3*n) * (2^(1 - (p+1)/n) +
	+ 4*cos((p+1)*pi/(3*n)) - 3*sin((n+p+1)*pi/(3*n))/sin(2*pi/3));


### Helper:
integrate(\(x) (1 - x^3)^(2/3) / (x^3 + 1), 0, 1)
(2^(2/3) - 1) * beta(1/3, 2/3) / 3
...
# Derivation:
integrate(\(x) x^3 * (1 - x^3)^(2/3) / (x^6 - x^3 + 1), 0, 1)
integrate(\(x) 1/3 * (x*(1-x)^2)^(1/3) / (x^2 - x + 1), 0, 1)
# y = x^3 / (1+x^3) => x^3 = 1/(1-y) - 1;
integrate(\(x) x^3 / (1 + x^3)^3 / ((x^3/(1+x^3))^2 - x^3/(1+x^3) + 1), 0, Inf)
integrate(\(x) x^3 / (1 + x^3) / (x^6 + x^3 + 1), 0, Inf)
integrate(\(x) x^4 / (x^3 + 1) / (x^6 + x^3 + 1), 0, Inf)
# Fraction decomposition:
m3 = exp(c(1,-1)*pi*1i/3);
integrate(\(x) 1/sqrt(3) / (x^3+1) *
	Im(m3[1]/(x^3 + m3[1]) - m3[2]/(x^3 + m3[2])), 0, Inf)
integrate(\(x) - 1/sqrt(3) *
	Im(m3[1]^2/(x^3 + 1) - m3[1]^2/(x^3 + m3[1]) +
	- m3[2]^2/(x^3 + 1) + m3[2]^2/(x^3 + m3[2])), 0, Inf)
integrate(\(x) - 1 / (x^3 + 1) + 1/sqrt(3) *
	Im(m3[1]^2/(x^3 + m3[1]) - m3[2]^2/(x^3 + m3[2])), 0, Inf)
m9 = exp(c(1,-1)*pi*1i/9);
integrate(\(x) - 1 / (x^3 + 1) + 1/sqrt(3) *
	Im(m3[1]*m9[1]/(x^3 + 1) - m3[2]*m9[2]/(x^3 + 1)), 0, Inf)
integrate(\(x) (-1 + 2/sqrt(3)*sin(4*pi/9)) / (x^3 + 1), 0, Inf)
beta(1/3,2/3) / 3 * (-1 + 2/sqrt(3)*sin(4*pi/9))
...
# Solution:
m3 = exp(c(1,-1)*pi*1i/3); m9 = exp(c(1,-1)*pi*1i/9);
...
### I( x^4 * (1 - x^3)^(1/3) / (x^6 - x^3 + 1) )
lim = 3/4
integrate(\(x) x^4 * (1 - x^3)^(1/3) / (x^6 - x^3 + 1), 0, lim)
integrate(\(x) 1/3 * (x^2*(1-x))^(1/3) / (x^2 - x + 1), 0, lim^3)
# Solution:
x  = lim/(1 - lim^3)^(1/3) / c(1, m9);
ff = c(1, - c(-1i,1i)/sqrt(3) * m3 * m9^2) / 3;
