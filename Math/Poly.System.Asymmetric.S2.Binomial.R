...
system.S2Cl3 = function(s1, s2, n=3, type="Ht", root.type="Power", withBase=FALSE, tol=1E-10, debug=TRUE) {
	...
	type = pmatch(type, c("Ht", "Simple", "Diff", "HtDual"));
	if(is.na(type)) stop("Unsupported type!");
	#
	p.gen = function(s, xn="x") {
		s.id = which(s != 0);
...
### Derivation
s = c(1, -2, 3, 0);
p = system.S2Cl3(s, s*c(-1,-1,1,0), n=3, type="Ht", root.type="Simple")
print.p(p[[1]], c("x","y"))
print.p(p[[2]], c("x","y"))
...
x = roots.Cl3(s1, n=3);
y = roots.Cl3(s2, n=3);
p = system.S2Cl3(s1, s2, n=3, type="Ht", root.type="Simple")
print.p(p[[1]], c("x","y"))
print.p(p[[2]], c("x","y"))
### Test:
...
x = roots.Cl3P(s1, n=n);
y = roots.Cl3P(s2, n=n);
p = system.S2Cl3(s1, s2, n=n, type="Ht", root.type="Powers")
print.p(p[[1]], c("x","y"))
print.p(p[[2]], c("x","y"))
### Test:
...
x = roots.Cl3P(s1, n=n);
y = roots.Cl3P(s2, n=n);
p = system.S2Cl3(s1, s2, n=n, type="HtDual", root.type="Powers")
print.p(p[[1]], c("x","y"))
print.p(p[[2]], c("x","y"))
### Test
