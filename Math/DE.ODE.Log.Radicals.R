...
x^2*(x^2+1)*(x^2 - d^2+1)*(x^2 - d^2 - d + 1) * d2y +
	+ x*(2*x^6 - (4*d^2 + 4*d - 5)*x^4 + (2*d^4 + 2*d^3 - 6*d^2 - 5*d + 4)*x^2 +
		+ (d-1)*(d^3+2*d^2-1)) * dy +
	- ((2*d+1)*x^4 - (2*d^2-d-2)*x^2 + (d-1)*(d^3+2*d^2-1)) * y +
	+ x^3*(x^2 + (d^2 + d + 1)) # = 0

### Special Cases:

# Case: d = 1
x^2*(x^4-1) * d2y + x*(2*x^4 - 3*x^2 - 3) * dy +
	- (3*x^2 + 1) * y + x*(x^2 + 3) # = 0
