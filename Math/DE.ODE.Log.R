...
### draft v.0.3m - v.0.3s:
# - [refactor] P(x)^LOG moved to new file:
#   DE.ODE.NL.Log.PowL.R;
# - [refactor] LOG( LOG ) moved to new file:
#   DE.ODE.NL.Log.Log.R;
...
#   DE.ODE.NL.Log.Int.R;
# - [refactor] LOG( OTHER(F(x)) ) moved to new file:
#   DE.ODE.NL.Log.Composite.R;
### draft v.0.3i - v.0.3j:
