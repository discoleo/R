...
# can substitute:
# A2_2 = (x1^2*x2^2 + x2^2*x3^2 + x3^2*x4^2 + x4^2*x1^2);
# but contains: E225;
(x1^5*x3^2*x4^2 + x2^5*x4^2*x1^2 + x3^5*x1^2*x2^2 + x4^5*x2^2*x3^2) +
