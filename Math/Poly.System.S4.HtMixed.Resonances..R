...
### b*x2^3*x3*x4 = R1 - x1^5 => Sq =>
b^2*x2^6*x3^2*x4^2 - x1^10 + 2*R1*x1^5 - R1^2 # = 0
### Sum =>
E622 = (x2^6*x3^2*x4^2 + x3^6*x4^2*x1^2 + x4^6*x1^2*x2^2 + x1^6*x2^2*x3^2);
b^2*E622 - (x1^10+x2^10+x3^10+x4^10) + 2*R1*(x1^5+x2^5+x3^5+x4^5) - 4*R1^2 # = 0
# E622 is computable;
...
### Sum(x2^3*x3*x4*...) =>
E4*E42 + b*(x2^6*x3^2*x4^2 + x3^6*x4^2*x1^2 + x4^6*x1^2*x2^2 + x1^6*x2^2*x3^2) - R1*E311 # = 0
E4*E42 + b*E622 - R1*E311 # = 0
b*E4*E42 + b^2*E622 - b*R1*E311 # = 0
# [redundant]
(x1^10+x2^10+x3^10+x4^10) - R1*(x1^5+x2^5+x3^5+x4^5) - b^2*E622 + b*R1*E311 # = 0
