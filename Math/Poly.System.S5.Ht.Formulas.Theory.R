...
# Relation:
E2a^12 + 8*E2a^8 - 50*E2a^6 + 16*E2a^4 - 3069*E2a^2 + 625 # = 0


### Test 2:
r0 = roots(c(1,0,0,0,-1,-1)); # [fixed]
...
round0(E2a^12 + 20*E2a^10 + 220*E2a^8 + 1120*E2a^6 + 2800*E2a^4 + 267*E2a^2 + 1600) # = 0


# roots(c(1,0,0,0,+/-1,1));
# x^12 - 10*x^10 + 55*x^8 - 140*x^6 + 175*x^4 - 3231*x^2 + 25
# x^12 + 10*x^10 + 55*x^8 + 140*x^6 + 175*x^4 - 3019*x^2 + 25

# roots(c(1,0,0,0,+/-2,1));
# x^12 - 20*x^10 + 220*x^8 - 1120*x^6 + 2800*x^4 - 6517*x^2 + 1600
# x^12 + 20*x^10 + 220*x^8 + 1120*x^6 + 2800*x^4 + 267*x^2 + 1600

# roots(c(1,0,0,0,+/-1,-2));
# x^12 - 10*x^10 + 55*x^8 - 140*x^6 + 175*x^4 - 50106*x^2 + 25
# x^12 + 10*x^10 + 55*x^8 + 140*x^6 + 175*x^4 - 49894*x^2 + 25

# p0 = as.pm(...) # THE MONSTER
replace.pm(p0, c(S=0, E3=0, E4=-1, E5=1)) |> replace.pm(as.pm("-E11a"), "E11b") |> print.pm(lead="E11a")
