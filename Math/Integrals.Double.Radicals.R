...
### Double Integrals:
# Radicals of Unit-Polynomials

### Examples:
# Gen Full: I( x^p * y^q * (1 - x*y)^k )
...
# - [refactor] moved SQRT Cases
#   to file: Integrals.Double.Radicals.SQRT.R;
...
### Gen: I( y/x * ((1 - x^n) / (1 - x^n*y^n))^(1/n) )
n = 3 + sqrt(7/2)
integrate(\(x) sapply(x, \(y) integrate(\(x)
	((1 - x^n) / (1 - x^n*y^n))^(1/n) * y/x - y/x, 0, 1, rel.tol=1E-13)$value), 0, 1, rel.tol=1E-13)
(digamma(1/n) - digamma(1/2+1/n)) / (4*n) - log(2)/(2*n) + 1/4;
...
# Var: I( x*y^p * ((1 - x) / (1 - x*y))^(1/n) )
integrate(\(x) sapply(x, \(y) integrate(\(x)
	x*y^p * ((1 - x) / (1 - x*y))^(1/n), 0, 1, rel.tol=1E-12)$value), 0, 1, rel.tol=1E-12)
((digamma(1/n) - digamma(p+1))*p/n + (p+1-1/n)*(p+1/n)/2) / ((p-1/n)*(p+1-1/n)*(p-1-1/n));

# Var: I( x*y^p * ((1 - x*y) / (1 - x))^(1/n) )
integrate(\(x) sapply(x, \(y) integrate(\(x)
...
### Gen: I( y^n / ((1-x) * (1-y^n) * (1 - x*y^n))^(1/n) )
n = sqrt(3) + sqrt(7);
integrate(\(x) sapply(x, \(y) integrate(\(x)
	y^n / ((1-x) * (1-y^n) * (1 - x*y^n))^(1/n), 0, 1, rel.tol=3E-12)$value), 0, 1, rel.tol=1E-12)
(pi / sin(pi/n) + beta(1/n, 2-3/n) * gamma(1-1/n)*gamma(-1/n)/gamma(1-2/n)/n) / (n-1);
# Note: (pi / sin(pi/n) + beta(1/n, 2-3/n) * beta(1-1/n, -1/n)/n) / (n-1);
...
### I( y^3 * ((1 - x^4) / (1 - x^4*y^4)^2)^(1/4) )
n = 4;
integrate(\(x) sapply(x, \(y) integrate(\(x)
	y^3 * ((1 - x^n) / (1 - x^n*y^n)^2)^(1/n), 0, 1, rel.tol=1E-13)$value), 0, 1, rel.tol=1E-13)
beta(1/4, 1/4) * beta(2/4, 3/4) / 32 - beta(1/4, 1/4) / 24;

### I( y^4 * ((1 - x^4) / (1 - x^4*y^4)^2)^(1/4) )
n = 4;
integrate(\(x) sapply(x, \(y) integrate(\(x)
	y^n * ((1 - x^n) / (1 - x^n*y^n)^2)^(1/n), 0, 1, rel.tol=1E-13)$value), 0, 1, rel.tol=1E-13)
pi * sqrt(2) / 12 - gamma(1/4)^2 * gamma(1/2) * sqrt(2) / (3*4^3);
...
beta(1/4, 1/2) * (pi * sqrt(2)/4 - 1 - log(tan(pi/8))/sqrt(2)) / 4;
...
beta(1/4, 1/2) * (1 + log(tan(pi/8))/sqrt(2)) / 4;

### I( y^2 * ((1 - x^4) / (1 - x^4*y^4)^3)^(1/4) )
integrate(\(x) sapply(x, \(y) integrate(\(x)
...
# 3/2 * I( x * ((1 - x^4) / (1 - x^4*y^4))^(1/4) ) +
# - 3/2 * I( x*y * ((1 - x^4) / (1 - x^4*y^4))^(3/4) );
# TODO
...
integrate(\(x) sapply(x, \(y) integrate(\(x)
	1 / ((1 - x^4) * (1 - x^4*y^4)^2)^(1/4), 0, 1, rel.tol=1E-11)$value), 0, 1, rel.tol=1E-12)
beta(1/4, 1/2) * log(sqrt(2) + 1) / 4;
beta(1/4, 1/4) * log(tan(3*pi/8)) / sqrt(2) / 4;

### I( y / ((1 - x^4) * (1 - x^4*y^4)^2)^(1/4) )
integrate(\(x) sapply(x, \(y) integrate(\(x)
	y / ((1 - x^4) * (1 - x^4*y^4)^2)^(1/4), 0, 1, rel.tol=1E-11)$value), 0, 1, rel.tol=1E-12)
beta(1/4, 1/4) / 8 - beta(3/4, 3/4) * pi / 16;

### I( y^2 / ((1 - x^4) * (1 - x^4*y^4)^2)^(1/4) )
integrate(\(x) sapply(x, \(y) integrate(\(x)
	y^2 / ((1 - x^4) * (1 - x^4*y^4)^2)^(1/4), 0, 1, rel.tol=1E-11)$value), 0, 1, rel.tol=1E-12)
0.5726319899892 * sqrt(2)/2;
# TODO: I( y / ((1 - x^4) * (1 - x^4*y^4))^(1/4) );
...
integrate(\(x) sapply(x, \(y) integrate(\(x)
	x^2 / ((1 - x^4) * (1 - x^4*y^4)^2)^(1/4), 0, 1, rel.tol=1E-11)$value), 0, 1, rel.tol=1E-12)
(1 - 1/sqrt(2)) * pi/2;

### I( x^2*y / ((1 - x^4) * (1 - x^4*y^4)^2)^(1/4) )
integrate(\(x) sapply(x, \(y) integrate(\(x)
	x^2*y / ((1 - x^4) * (1 - x^4*y^4)^2)^(1/4), 0, 1, rel.tol=1E-11)$value), 0, 1, rel.tol=1E-12)
beta(1/4, 3/4) * (pi - 2*log(2)) / 32;

### I( x^2*y^2 / ((1 - x^4) * (1 - x^4*y^4)^2)^(1/4) )
integrate(\(x) sapply(x, \(y) integrate(\(x)
	x^2*y^2 / ((1 - x^4) * (1 - x^4*y^4)^2)^(1/4), 0, 1, rel.tol=1E-11)$value), 0, 1, rel.tol=1E-12)
(gamma(-1/4)*gamma(3/4) / gamma(1/2) / 4 + 1) * pi * sqrt(2) / 4;


### I( x^4 / ((1 - x^4) * (1 - x^4*y^4)^2)^(1/4) )
integrate(\(x) sapply(x, \(y) integrate(\(x)
	x^4 / ((1 - x^4) * (1 - x^4*y^4)^2)^(1/4), 0, 1, rel.tol=1E-11)$value), 0, 1, rel.tol=1E-12)
beta(1/4, 1/4) / 24;

# Derived: I( ((1 - x^4)^3 / (1 - x^4*y^4)^2)^(1/4) )
integrate(\(x) sapply(x, \(y) integrate(\(x)
	((1 - x^4)^3 / (1 - x^4*y^4)^2)^(1/4), 0, 1, rel.tol=1E-11)$value), 0, 1, rel.tol=1E-12)
beta(1/4, 1/4) * log(tan(3*pi/8)) / sqrt(2) / 4 - beta(1/4, 1/4) / 24;
...
### I( y^4 / ((1-x) * (1-y^4) * (1 - x*y^4))^(1/4) )
n = 4;
integrate(\(x) sapply(x, \(y) integrate(\(x)
	y^n / ((1-x) * (1-y^n) * (1 - x*y^n))^(1/n), 0, 1, rel.tol=3E-12)$value), 0, 1, rel.tol=1E-12)
pi * (sqrt(2) - 1) / 3;
(pi / sin(pi/n) - beta(1/n, 2-3/n) * beta(1-1/n, 1-1/n) * (n-2)/n) / (n-1);
(pi / sin(pi/n) + beta(1/n, 2-3/n) * gamma(1-1/n)*gamma(-1/n)/gamma(1-2/n)/n) / (n-1);
