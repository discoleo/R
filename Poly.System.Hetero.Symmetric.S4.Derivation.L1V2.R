...
6*(b + 1)*E3*S + (5*b^2 - 4*b - 4)*E2^2 +
	...
	- (2*b^2 - 8*b - 10)*R*S^2 - 16*(b + 1)*R^2 # = 0
...
2*b^2*E3*S - (4*b^4 + 4*b^2)*E4 +
	+ (5*b^2 - 4*b + 4)*E2^2 - (5*b^2 - 4*b + 4)*E2*S^2 + (12*b^2 - 16*b + 16)*R*E2 +
	+ (b^2 - b + 1)*S^4 - (4*b^2 - 8*b + 8)*R*S^2 + (4*b^2 - 16*b + 16)*R^2 # = 0
# Reduction =>
(4*b^4 + 4*b^2)*E4 + (b^3 - 2*b + 3)*E3*S +
	- (5*b^2 - 4*b + 4)*E2^2 + (2*b^2 - b + 1)*E2*S^2 - (12*b^2 - 16*b + 16)*R*E2 +
